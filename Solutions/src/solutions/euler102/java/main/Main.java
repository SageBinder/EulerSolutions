package solutions.euler102.java.main;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for(ArrayList<Point> triangle : triangleList) {
            ...
            if(triangleContainsOrigin(point0, point1, point2)) {
    ...
    private static boolean triangleContainsOrigin(Point point0, Point point1, Point point2) {
    ...
    private static void parseTriangleString() {
        ...
        for(char c : triangleString.toCharArray()) {
            if(c == ',') {
                if(xOrY == 0) {
